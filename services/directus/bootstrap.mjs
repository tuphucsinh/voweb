...
await field('products','status','string',statusMeta); await field('products','slug','string'); await field('products','brand_slug','string'); await field('products','name','string'); await field('products','flavor','string'); await field('products','pack','string'); await field('products','source_url','string');
